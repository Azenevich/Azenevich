...
*Jan 2022 – Present*  
- Clarified requirements with customers and stakeholders
- Designed and maintained test documentation (test plans, test cases, checklists, test result reports) 
- Performed manual testing of web, mobile, desktop, and VR-related components (functional, regression, integration, exploratory, smoke, immersive)
...
- [Meta on Coursera](https://www.coursera.org/) / Course "Programming with JavaScript" / May 15, 2025
- [Udemy](https://www.udemy.com/) / Course "Wanna Learn JMeter? Get Training by Industry Experts-23+hrs" / Jan. 7, 2024
- [Udemy](https://www.udemy.com/) / Course "Software performance testing using JMeter" / Oct. 10, 2023
